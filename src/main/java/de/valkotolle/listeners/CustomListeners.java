package de.valkotolle.listeners;
...
import de.valkotolle.utilities.MonitoringMail;
import de.valkotolle.utilities.TestConfig;
...
//		try {
			...
			log.debug("****************************************" );
			log.debug("*** Function SendMail is deactivated ***" );
			log.debug("****************************************" );
